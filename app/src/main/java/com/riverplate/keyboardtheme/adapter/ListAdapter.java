package com.riverplate.keyboardtheme.adapter;

import com.riverplate.keyboardtheme.R;
import com.riverplate.keyboardtheme.module.constants.AppConstants;
...
public class ListAdapter extends BaseAdapter{
	...
	class ViewHolder
	{
		ImageView imageItem,transparant;
		TextView themes_no;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null)
		{
			...
			layoutInflater =  (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			 ...
			 holder.transparant = (ImageView) convertView.findViewById(R.id.imageView2);
