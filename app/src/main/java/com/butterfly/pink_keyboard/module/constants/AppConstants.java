package com.butterfly.pink_keyboard.module.constants;
...
public class AppConstants {
    ...
    public static final int[] THEMES_LIST = {R.drawable.keyboard_bg1, R.drawable.keyboard_bg2,
    										 R.drawable.keyboard_bg3, R.drawable.keyboard_bg4,
    										 R.drawable.keyboard_bg5, R.drawable.keyboard_bg6,
    										 R.drawable.keyboard_bg7, R.drawable.keyboard_bg8,
    										 R.drawable.keyboard_bg9, R.drawable.keyboard_bg9,};
