package com.butterfly.pink_keyboard; //replace with your own package (if needed)
...
public class Ads{
    ...
    private static final String AD_MANAGER_AD_UNIT_ID = "ca-app-pub-9413304849687382/2370670054";
